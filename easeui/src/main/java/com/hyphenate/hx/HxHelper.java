...
/* 手动注释
import com.hyphenate.hx.conference.ConferenceActivity;
*/
import com.hyphenate.hx.db.DemoDBManager;
import com.hyphenate.hx.db.InviteMessgeDao;
import com.hyphenate.hx.db.UserDao;
import com.hyphenate.hx.domain.EmojiconExampleGroupData;
import com.hyphenate.hx.domain.InviteMessage;
import com.hyphenate.hx.domain.InviteMessage.InviteMessageStatus;
import com.hyphenate.hx.domain.RobotUser;
import com.hyphenate.hx.parse.UserProfileManager;
import com.hyphenate.hx.receiver.CallReceiver;
/* 手动注释
import com.hyphenate.hx.ui.ChatActivity;
import com.hyphenate.hx.ui.MainActivity;
import com.hyphenate.hx.ui.VideoCallActivity;
import com.hyphenate.hx.ui.VoiceCallActivity;
*/
import com.hyphenate.hx.utils.PreferenceManager;
...
public class HxHelper {
     ...
     * @return
     */
    public void setUserNameAndIcon(String hxid, String nick, String avatar) {
        // To get instance of EaseUser, here we get it from the user list in memory
        // You'd better cache it if you get it from your server
        EaseUser easeUser;
        if (!TextUtils.isEmpty(hxid)) {
            easeUser = getContactList().get(hxid);
     ...
     * @param avatar
     */
    public void setCurrNameandIcon(String nick, String avatar) {
        if (!TextUtils.isEmpty(nick)) {
            getUserProfileManager().setCurrentUserNick(nick);
        }
        if (!TextUtils.isEmpty(avatar)) {
            getUserProfileManager().setCurrentUserAvatar(avatar);
        }
    }
...
*/
        ...
        //set notification options, will use default if you don't set it 手动注释
