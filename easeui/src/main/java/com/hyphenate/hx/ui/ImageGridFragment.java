...
import com.hyphenate.hx.domain.VideoEntity;
import com.hyphenate.hx.video.util.ImageCache;
import com.hyphenate.hx.video.util.ImageResizer;
import com.hyphenate.hx.video.util.Utils;
import com.hyphenate.hx.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
    ...
    private long maxVideoSize = 10 * 1024 * 1024;
    ...
    public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
        ...
        if (position == 0) {
            ...
            if (vEntty.size > maxVideoSize) {
                Toast.makeText(getContext(), "暂不支持超过10M的视频！", Toast.LENGTH_SHORT).show();
            } else {
